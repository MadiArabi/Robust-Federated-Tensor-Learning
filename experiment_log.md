...
- [ ] Spot-check job 9370's prediction results against local reproduction with the fixed code (in progress) — determine whether the "oracle collapse" finding needs to be re-run too
